...
export class ReportesController {
  ...
  @ApiResponse({ status: 200, description: 'Reporte de ventas generado exitosamente', schema: { example: {
    fechaReporte: '2023-10-27T10:00:00.000Z',
    filtrosAplicados: {
      ...
      data: [
        {
          ...
          fecha_hora_factura: '2023-10-27T09:30:00.000Z',
