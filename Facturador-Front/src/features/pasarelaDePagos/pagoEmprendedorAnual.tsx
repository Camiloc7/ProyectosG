...
const PagoEmprendedorAnual: React.FC<EpaycoModalProps> = ({
  isOpen,
  onClose,
}) => {
  useEffect(() => {
    if (isOpen) {
      ...
      script.setAttribute('data-epayco-amount', '856800');
      script.setAttribute('data-epayco-tax', '136800.00');
      script.setAttribute('data-epayco-tax-ico', '0.00');
      script.setAttribute('data-epayco-tax-base', '720000');
      script.setAttribute(
        'data-epayco-name',
        'LICENCIA ANUAL SOFTWARE DE FACTURACIÓN ELECTRÓNICA | Facturas de venta ilimitadas | Ingresos hasta $60.000.000 COP Mensuales'
      );
      script.setAttribute(
      ...
      script.setAttribute(
        ...
        'https://qualitybillservice.qualitysoftservice.com/App/index.php/payment_controller/response'
      );
      script.setAttribute(
        'data-epayco-confirmation',
        'https://qualitybillservice.qualitysoftservice.com/App/index.php/payment_controller/confirmation'
      );
      script.setAttribute(
        'data-epayco-button',
...
export default PagoEmprendedorAnual;
