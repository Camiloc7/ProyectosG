...
import { validateSeleccionMultiple } from '../../../validacionesDeBusqueda';
...
const FormItemMenu: React.FC<ModalFormProps> = ({ isOpen, onClose, id }) => {
  const {
    postItem,
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <h2 className="text-xl font-bold flex-1 text-center">
              {id ? 'Actualizar' : 'Nuevo'} Producto del Menu
            </h2>
