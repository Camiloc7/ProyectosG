      ...
      <div ref={ref} className="relative w-full">
        <div className="relative">
          <input
            ...
            } rounded-[25px] text-[#00A7E1] w-full text-sm focus:ring-blue-300 
            focus:outline-none shadow-sm placeholder-[#00A7E1]
            ${
              disabled
            ...
            onChange={!disabled ? handleInputChange : undefined} // 👈 bloqueo eventos
            onFocus={handleInputFocus}
            onClick={() => setSearchBarIsOpen(true)}
            onKeyDown={handleKeyDown}
            disabled={disabled} // 👈 atributo real de input
          />
