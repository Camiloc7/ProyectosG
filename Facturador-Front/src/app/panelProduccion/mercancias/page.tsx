    ...
    <PrivateRoute>
      <LayoutAdmi>
        <div className="p-8 bg-[#F7F7F7] min-h-screen">
          <h1 className="text-3xl font-bold mb-8 text-gray-700 text-center">Recepción de Mercancías</h1>
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center mb-2">
                <input
                  ...
                  className="mr-2"
                />
                <label htmlFor="isNewProduct" className="text-sm text-gray-600">Crear nuevo producto</label>
              </div>
              {!isNewProduct ? (
                <div>
                  <select
