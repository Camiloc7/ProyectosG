  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: 14, color: "#4a4a4a", marginBottom: 8 }}>
          En "Quality Soft Service", valoramos su privacidad y nos comprometemos
          a proteger sus datos personales. Esta Política de Privacidad describe
          cómo recopilamos, usamos, compartimos y protegemos su información
        ...
        >
          ...
          <li>
            Con proveedores de servicios que ayudan a operar nuestra aplicación
        ...
        <p style={{ fontSize: 14, color: "#4a4a4a", marginBottom: 8 }}>
          ...
          para cumplir con los fines descritos en esta política, a menos que se
          requiera o permita un período de retención más largo por ley.
        </p>
        ...
        <p style={{ fontSize: 14, color: "#4a4a4a", marginBottom: 8 }}>
          ...
          cualquier momento. Notificaremos cualquier cambio publicando la nueva
          versión en nuestra aplicación y, si corresponde, enviando un aviso
          adicional.
        </p>
        ...
        <p style={{ fontSize: 14, color: "#4a4a4a", marginBottom: 8 }}>
          Las cookies también nos ayudan a mantener la seguridad de su cuenta y
          a proteger la información que proporciona al acceder a nuestras
