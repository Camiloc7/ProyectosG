    ...
    <div className="p-8 bg-gray-100 min-h-screen text-gray-900 font-sans">
      <div className="flex items-center justify-between mb-8 pb-4 border-b-2 border-gray-200">
        <h2 className="text-4xl font-extrabold text-gray-900">
          Detalles del Pedido{" "}
          <span className="text-orange-500">#{pedido.id.slice(-4)}</span>
        </h2>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        ...
        >
          ...
          <p className="text-gray-600 mb-2">
            <strong>Origen:</strong> {pedido.tipo_pedido}
          </p>
          <p className="text-gray-600 mb-2">
            <strong>Fecha:</strong>{" "}
            {format(new Date(pedido.created_at), "PPP p", { locale: es })}
          </p>
          {pedido.mesa_numero && (
        ...
        >
          ...
          <p className="text-gray-600 mb-2">
            <strong>Nombre:</strong> {pedido.cliente_nombre || "N/A"}
          </p>
          <p className="text-gray-600 mb-2">
            <strong>Teléfono:</strong> {pedido.cliente_telefono || "N/A"}
          </p>
          <p className="text-gray-600 mb-2">
            <strong>Dirección:</strong> {pedido.cliente_direccion || "N/A"}
          </p>
        </div>
        <div
          className="p-6 rounded-3xl shadow-xl transition-transform transform hover:scale-105"
        ...
        >
          ...
          <p className="text-gray-600 mb-2">
            ...
            <span className="font-bold text-xl text-gray-900">
              ${Number(pedido.total_estimado).toFixed(2)}
            </span>
          </p>
          <p className="text-gray-600">
            <strong>Notas del pedido:</strong> {pedido.notas || "N/A"}
          </p>
        </div>
      </div>
      <div
