...
const tipStyles = {
  container: { marginTop: 12 } as React.CSSProperties,
  row: { display: 'flex', alignItems: 'center', marginBottom: 8,} as React.CSSProperties,
  label: { marginRight: 8, color: '#000'  } as React.CSSProperties,
  input: {
    width: 60,
    padding: 4,
  ...
  hr: { border: 'none', borderTop: '1px solid #ddd', margin: '8px 0' } as React.CSSProperties,
  line: {
    display: 'flex',
  ...
  return (
    <div style={tipStyles.container}>
      <div style={tipStyles.row}>
        <Checkbox label="Dejar propina" checked={tipEnabled} onChange={onToggleTip} />
      </div>
