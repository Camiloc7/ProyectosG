...
const PedidoInfoModal: React.FC<PedidoInfoModalProps> = ({
  pedido,
  isOpen,
  onClose,
}) => {
  ...
  const renderHeader = () => {
    const origen =
      tiposDeOrigen[pedido.tipo_pedido as keyof typeof tiposDeOrigen];
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Botón cerrar */}
        <BotonRestaurante label="Cerrar" onClick={onClose} />
      </div>
    </div>
  );
};
