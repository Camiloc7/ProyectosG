    ...
    <div style={{ width: width, marginBottom: 15 }}>
      ...
      <div ref={ref} style={{ position: 'relative', marginTop: 12 }}>
        <input
          ...
          onClick={() => !disabled && setSearchBarIsOpen(true)} // <-- respeta disabled
          onFocus={!disabled ? handleInputFocus : undefined} // <-- respeta disabled
          onKeyDown={!disabled ? handleKeyDown : undefined} // <-- respeta disabled
          readOnly
          disabled={disabled} // <-- HTML nativo
          style={{
            height,
            padding: '0 16px',
            ...
            color: COLOR_TEXTO,
            width: '100%',
            backgroundColor: disabled ? '#f3f4f6' : COLOR_INPUT_BG, // gris si está disabled
            boxShadow: '0 1px 2px rgba(0,0,0,0.05)',
            cursor: disabled ? 'not-allowed' : 'pointer',
            boxSizing: 'border-box',
            fontFamily: 'Lato, sans-serif',
            opacity: disabled ? 0.6 : 1 // efecto visual
          }}
        />
        <span
