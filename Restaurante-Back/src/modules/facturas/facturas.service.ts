...
export class FacturasService {
    ...
    public async createFacturaAndPaymentForOrder(
        ...
        try {
            ...
            nuevaFactura.cierre_caja_id = cierreCaja?.id || null;
            ...
            const newPagoEntity = queryRunner.manager.create(PagoEntity, {
                ...
                establecimiento_id: establecimientoId,
                cuenta_bancaria_id: cuentaBancariaParaApi.id,
                monto_recibido: createFacturaAndPaymentDto.monto_pagado,
                ...
                cierre_caja_id: cierreCaja?.id || null,
    ...
    private async enviarFacturaAPIExterna(
        ...
        try {
            ...
            if (axios.isAxiosError(error) && error.code === 'ECONNABORTED') {
                console.error('[enviarFacturaAPIExterna] ERROR: Tiempo de espera (TIMEOUT) o conexión abortada con la API externa.');
            } else {
